...
const api = axios.create({
  // baseURL: "https://finance-api-test.nouh-agency.com/api",
...
export const getDepositTresure = (id) => api.get(`/data/deposit/tresure/${id}`);
...
export const getTresureFundsByMoneyTransfer = (money_transfer_id) => {
  return api.get(`/data/tresure-funds/by-money-transfer/${money_transfer_id}`);
};
...
// TresureFund
export const getAllTresureFunds = () => {
  return api.get("/data/tresure_funds");
};
export const createTresureFund = (data) => {
  return api.post("/data/tresure_funds", data);
};
export const updateTresureFund = (id, data) => {
  return api.put(`/data/tresure_funds/${id}`, data);
};
export const getTresureFundById = (id) => {
  return api.get(`data/tresure_funds/${id}`);
};
export const deleteTresureFund = (id) => {
  return api.delete(`/data/tresure_funds/${id}`);
};

// Report for tresureFund
...
export const getTresuresforAllusersReport = (user_type) => {
  return api.get(`/data/tresure-funds/${user_type}/users/report`);
};
