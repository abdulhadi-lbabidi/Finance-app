...
import { getInnerTransactions } from "../../api";
import {
  ...
  const filteredItems = useMemo(() => {
    ...
    if (
      ...
      filteredUsers = filteredUsers.filter((innerTransaction) =>
        Array.from(statusFilter).includes(innerTransaction.status)
      );
    }

    return filteredUsers;
  }, [innerTransactions, filterValue, statusFilter]);
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex justify-between items-center">
          <span className="text-default-400 text-small">
            عدد سجلات الإيرادات {innerTransactions.length}
          </span>
...
export default InnerTransactionTable;
