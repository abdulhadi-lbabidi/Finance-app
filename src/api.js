...
export const getPhones = (type,id) => api.get(`/data/phone?type=${type}&id=${id}`);
...
export const getSocialMedias = (type,id) => api.get(`/data/socialmedia?type=${type}&id=${id}`);


// socialmedia types
export const getSocialMediaTypes = () => api.get('/data/socialmediatype');
export const getSocialMediaTypedata = (id) => api.get(`/data/socialmediatype/${id}`);
...
// MoneyTransfare
export const getMoneyTransfares = (id) => api.get(`/data/moneytransfare?tresurefund_id=${id}`);
export const getMoneyTransfaredata = (id) => api.get(`/data/moneytransfare/${id}`);
...
// InnerTransaction
export const getInnerTransactions = (id) => api.get(`/data/innertrans?tresurefund_id=${id}`);
export const getInnerTransactiondata = (id) => api.get(`/data/innertrans/${id}`);
...
// OuterTransaction
export const getOuterTransactions = (id) => api.get(`/data/outertrans?tresurefund_id=${id}`);
export const getOuterTransactiondata = (id) => api.get(`/data/outertrans/${id}`);
...
export const getWorkshopEmployee = (id) => api.get(`/data/workshopre/employee/${id}`);
export const getWorkshopEmployeeInfo = (id) => api.get(`/data/workshopre/getemployee/${id}`);
...
export const getWorkshopLogistic = (id) => api.get(`/data/workshopre/logistic/${id}`);
export const getWorkshopLogisticInfo = (id) => api.get(`/data/workshopre/getlogistic/${id}`);
...
export const getTresureSelector = (type) => api.get(`/data/tresure?type=${type}`);
export const getAdminTresure = (id) => api.get(`/data/admin/tresure/${id}`);
export const getWorkshopTresure = (id) => api.get(`/data/workshop/tresure/${id}`);
